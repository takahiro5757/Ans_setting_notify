  ...
  return (
    <Box sx={{ bgcolor: '#f5f5f5', minHeight: 'calc(100vh - 64px)', py: 3 }}>
      <Container maxWidth={false} sx={{ position: 'relative' }}>
        ...
        <Box sx={{ position: 'sticky', top: 0, zIndex: 10, bgcolor: '#f5f7fa', borderRadius: 2, mb: 3, p: 3 }}>
          {/* 年月週選択コンポーネント */}
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-end', flexWrap: 'nowrap', height: '58px', mb: 2 }}>
            <YearMonthSelector
              year={year}
              month={month}
