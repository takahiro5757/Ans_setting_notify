...
const RateCell: React.FC<RateCellProps> = ({ staffId, date, isWeekend, hasConfirmedLocation }) => {
  ...
  return (
    <Cell 
      ...
      sx={{
        ...
        cursor: hasConfirmedLocation ? 'pointer' : 'default',
        '&:hover': hasConfirmedLocation ? { 
